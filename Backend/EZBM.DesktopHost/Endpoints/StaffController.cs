...
public static class StaffController
{
    ...
    public static async Task<IResult> CreateStaff(
    ...
    public static async Task<IResult> GetStaff(
        [FromBody] GetStaffRequest request)
    {
    ...
    public static async Task<IResult> FindStaff(
        [FromBody] FindStaffRequest request)
    {
    ...
    public static async Task<IResult> UpdateStaff(
    ...
    public static async Task<IResult> DeleteStaff(
    ...
    public static async Task<IResult> CreateAttendance(
    ...
    public static async Task<IResult> GetAttendance(
        [FromBody] GetAttendanceRequest request)
    {
    ...
    public static async Task<IResult> FindAttendance(
        [FromBody] FindAttendanceRequest request)
    {
    ...
    /// <param name="request">The request parameters containing update fields and ID.</param>
    /// <returns>An HTTP result indicating the status of the update.</returns>
    public static async Task<IResult> UpdateAttendance(
    ...
    /// <returns>An HTTP result indicating the status of the deletion.</returns>
    public static async Task<IResult> DeleteAttendance(
    ...
    public static async Task<IResult> CreatePayroll(
    ...
    public static async Task<IResult> GetPayroll(
        [FromBody] GetPayrollRequest request)
    {
    ...
    public static async Task<IResult> FindPayroll(
        [FromBody] FindPayrollRequest request)
    {
    ...
    /// <returns>An HTTP result indicating the status of the deletion.</returns>
    public static async Task<IResult> DeletePayroll(
